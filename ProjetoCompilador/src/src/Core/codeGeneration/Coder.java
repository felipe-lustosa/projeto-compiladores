...
public class Coder implements Visitor {
  ...
  public Coder(byte op, byte r, byte n, short d) {
    this.op = op;
    this.r = r;
    this.n = n;
    this.d = d;
  ...
  public Object visitProgram (ProgramaNode prog, Object arg) {
  ...
  public Object visitIfCommand (ComandoCondicionalNode com, Object arg)  {
    com.E.visit (this, arg);
  ...
  public void encode (ProgramaNode prog) {
